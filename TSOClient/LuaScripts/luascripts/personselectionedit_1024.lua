...
CASScreen:CreateButton(0x3E0, 0x001, 958, 80, 1, false, "CancelButton")
CASScreen:CreateNetworkButton(0x81C, 0x001, 958, 151, 1, false, "AcceptButton")
CASScreen:CreateButton(0x81D, 0x001, 978, 15, 1, false, "ExitButton")

CASScreen:CreateButton(0x3E4, 0x001, 380, 188, 1, false, "FemaleButton")
CASScreen:CreateButton(0x3EB, 0x001, 380, 260, 1, false, "MaleButton")
CASScreen:CreateButton(0x81F, 0x001, 382, 352, 1, false, "SkinLightButton")
CASScreen:CreateButton(0x820, 0x001, 382, 416, 1, false, "SkinMediumButton")
CASScreen:CreateButton(0x81E, 0x001, 382, 480, 1, false, "SkinDarkButton")

CASScreen:CreateButton(0x822, 0x001, 270, 490, 1, false, "ScrollUpButton")
CASScreen:CreateButton(0x821, 0x001, 270, 697, 1, false, "ScrollDownButton")

CASScreen:CreateTextEdit(33, 364, 194, 195, false, 499)

Heads = CASScreen:CreateHeadCatalogBrowser(518, 77, "HeadBrowser")
