...
namespace FSO.Common.DataService.Model
{
    ...
    {
        private List<uint> _LotAdmitInfo_AdmitList;
        [Persist]
        public List<uint> LotAdmitInfo_AdmitList
        {
        ...
        private List<uint> _LotAdmitInfo_BanList;
        [Persist]
        public List<uint> LotAdmitInfo_BanList
        {
