...
namespace FSO.Server.Servers.Api.JsonWebToken
{
    ...
    public class JWTFactory
    {
        ...
        public JWTUserIdentity DecodeToken(string token)
        {
            ...
            return Newtonsoft.Json.JsonConvert.DeserializeObject<JWTUserIdentity>(payloadParsed["data"]);
        }

        public JWTInstance CreateToken(JWTUserIdentity data)
        {
