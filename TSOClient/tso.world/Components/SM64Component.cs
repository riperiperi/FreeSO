...
namespace FSO.LotView.Components
{
    ...
    internal class VisualMario : IDisposable
    {
        ...
        public List<Matrix> LastAnimMatrices;

        public Vector3? Position;
        public Vector3? Rotation;
        public Vector3? Scale;
        public List<Matrix> AnimMatrices;
    ...
    public class SM64Component : IDisposable
    {
        ...
        private void DrawMario(GraphicsDevice gd, WorldState state, VisualMario visual)
        {
            ...
            if (visual.NewFrame)
            {
                ...
                visual.LastAnimMatrices = visual.AnimMatrices ?? matrices;
                visual.AnimMatrices = matrices;
            ...
            for (int i=0; i<matrices.Count; i++)
            {
                ...
                {
                    newMatrices.Add(new Matrix()); // Remove the head.
                }
                else
                {
                    newMatrices.Add(matrices[i]); // Matrix.Lerp(visual.LastAnimMatrices[i], matrices[i], visual.InterpProgress));
                }
            ...
            */
            ...
            if (visual.Avatar != null)
            {
                ...
                foreach (var pass in technique.Passes)
                {
                    ...
                    avatar.Avatar.DrawHeadOnly(gd, aEffect, rotateHead * Matrix.CreateScale(WorldToSm64 * 3.8f) * Matrix.CreateTranslation(new Vector3(35, 0, 0)) * visual.AnimMatrices[2]);
                }
            }
        }
