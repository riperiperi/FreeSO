...
{
    public class InjectBroadcast
    {
        public static InjectBroadcast Instance;
        ...
        {
            private readonly InjectBroadcast _hub;
            private readonly Action<string> _handler;

            public Subscription(InjectBroadcast hub, Action<string> handler)
            {
                _hub = hub;
                _handler = handler;
            }
