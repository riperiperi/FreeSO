    ...
    public class VisualSurroundPuppets
    {
        ...
        private void SignalMessage(SurroundPuppet puppet)
        {
            ...
            if (puppet.Message.Text != null && chatPanel != null)
            {
                ...
                chatPanel.ReceiveEvent(new VMChatEvent(puppet.PersistID, message.Color, message.TTSPitch, message.Gender, VMChatEventType.SurroundMessage, message.Name, message.Text));
            }
        }
