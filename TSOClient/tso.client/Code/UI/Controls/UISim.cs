...
namespace TSOClient.Code.UI.Controls
{
    ...
    public class UISim : UIElement
    {
        ...
        public UISim()
        {
            ...
            SimScene = new _3DScene();
            SimScene.ID = "SimScene";
            SimScene.Camera = new BasicCamera(GameFacade.GraphicsDevice, new Vector3(0.0f, 7.0f, -17.0f), Vector3.Zero, Vector3.Up);
            ...
            //scene.Add(a);
            GameFacade.Scenes.Add(SimScene);
        }
