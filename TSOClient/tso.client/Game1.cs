...
namespace TSOClient
{
    ...
    public class Game1 : tso.common.rendering.framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            using (var printer = new HTMLPrinter(GraphicsDevice, @"C:\Users\Darren\Desktop\tso.workingdir\walls", "walls"))
            {
                var iffPrinter = new IffPrinter(printer);
                var floor = tso.content.Content.Get().WorldFloors.Get(10);
                iffPrinter.PrintAll(new Iff(@"C:\Program Files\Maxis\The Sims Online\TSOClient\objectdata\globals\walls.iff"));
                //iffPrinter.PrintAll(tso.content.Content.Get().WorldFloors.List()[0].Get().);
            }
