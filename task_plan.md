...
- [x] **Aries city session through FindLot** — ClientOnline → ArchiveAvatarSelect → FindLotResponse FOUND (`127.0.0.1:34101`). Lot TCP/WS still open.
- [ ] **Lot join** — open `/lot` (or address from FindLot) → lot HostOnline/ClientOnline; then .NET-WASM protocol or grow JS in KNI client.
