...
| S5 | LotView + Vitaboy; empty lot | Lot camera + floor — **placeholder DONE** + Mario optional (`FSO_NO_SM64`/`BLAZORGL`) + MapGenerationiOS fallback. Real `ExternalWorld` still needs full KNIF lot FX set + LotView net8 dual-target. |
