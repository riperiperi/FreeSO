_This page explains how to build the 2024 FreeSO codebase with .NET Framework. For information on the newer Archive client, see [Building FreeSO.](./Building%20FreeSO.md)_
...
First, make sure you have cloned FreeSO _with_ submodules. If the folder `./Other/libs/FSOMonoGame/` is empty, you haven't done it right.
