...
//
// Auto-generated from eastjerome on 2015-06-21 17:19:07Z.
...
public partial class EastJerome : DataContext
{
	...
	public EastJerome(string connectionString) : 
			base(connectionString)
	{
		this.OnCreated();
	}
	
	public EastJerome(string connection, MappingSource mappingSource) : 
			base(connection, mappingSource)
	{
		this.OnCreated();
	}
	
	public EastJerome(IDbConnection connection, MappingSource mappingSource) : 
			base(connection, mappingSource)
	{
		this.OnCreated();
	}
...
public partial class EastJerome
{
	...
	public EastJerome(IDbConnection connection, IVendor sqlDialect) : 
			base(connection, sqlDialect)
	{
		this.OnCreated();
	}
	
	public EastJerome(IDbConnection connection, MappingSource mappingSource, IVendor sqlDialect) : 
